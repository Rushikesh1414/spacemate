...
import 'package:stumato_assignment/widgets/default_loader.dart';

import '../../services/onBoarding_nav.dart';
import '../../widgets/custom_gridview.dart';
import '../../widgets/header_text.dart';
import 'access_view_model.dart';

class AccessView extends StackedView<AccessViewModel> {
  const AccessView({super.key});

  @override
  Widget builder(
      BuildContext context, AccessViewModel viewModel, Widget? child) {
  ...
  @override
  AccessViewModel viewModelBuilder(BuildContext context) {
    // TODO: implement viewModelBuilder
    return AccessViewModel();
  }

  @override
  void onViewModelReady(AccessViewModel viewModel) {
    // Pass the feature label here
    viewModel.getAccessData();
  }
}
